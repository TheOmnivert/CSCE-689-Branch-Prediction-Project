#include "seznec_tagesc_768kb.h"

#include "instruction.h"

#include "my_cond_branch_predictor.hpp"

int seznec_tagesc_768kb::cbp_branch_type(uint8_t branch_type)
{
  switch (branch_type) {
...
void seznec_tagesc_768kb::initialize_branch_predictor() { cbp2025.setup(); }

bool seznec_tagesc_768kb::predict_branch(champsim::address ip, champsim::address predicted_target, bool always_taken, uint8_t branch_type)
{
...
void seznec_tagesc_768kb::last_branch_result(champsim::address ip, champsim::address branch_target, bool taken, uint8_t branch_type)
{
