...
// Fixed budget controls for this Jimenez MPP 96KB variant.
//  - total predictor budget: 96KB
//  - internal TAGE-SC-L share: 32KB
//  - Bloom filter bits excluded from budget accounting
#define JIMENEZ_MPP_TOTAL_BUDGET_KB 96
#define JIMENEZ_MPP_TAGE_BUDGET_KB 32
